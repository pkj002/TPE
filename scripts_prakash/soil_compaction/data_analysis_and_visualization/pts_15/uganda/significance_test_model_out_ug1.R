...
## combine 
all <- data.frame(comp=c(rep('orig',60),rep('bd8',60),rep('bd17',60)),rbind(var_orig2_cul,srgfP_cul,srgfO_cul))
pww<- all[,1:4]
...
write.csv(top1, 'E:/Prakash/dssat_outputs/uganda/significance/top.csv')
...
write.csv(top2, 'E:/Prakash/dssat_outputs/uganda/significance/root.csv')
