...
## combine 
all <- data.frame(comp=c(rep('orig',120),rep('bd8',120),rep('bd17',120)),rbind(var_orig2_cul,srgfP_cul,srgfO_cul))
pww<- all[,1:4]
...
write.csv(top1, 'E:/Prakash/dssat_outputs/ethiopia/significance/top.csv')
...
write.csv(top2, 'E:/Prakash/dssat_outputs/ethiopia/significance/root.csv')
