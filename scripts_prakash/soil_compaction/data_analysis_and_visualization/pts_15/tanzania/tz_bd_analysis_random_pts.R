...
ggsave(paste0(out_dir,'boxplot_root_rel.png'), pp, width=10, height=10, dpi=600)
ggsave(paste0(out_dir,'boxplot_shoot_rel.png'), pp2, width=10, height=10, dpi=600)
...
ggsave(paste0(out_dir,'boxplot_root_Abs2c.png'), pp3, width=10, height=10, dpi=600)
ggsave(paste0(out_dir,'boxplot_shoot_Abs2c.png'), pp4, width=10, height=10, dpi=600)
...
ggsave(paste0(out_dir,'boxplot_srgfP_root_rel.png'), gg, width=10, height=10, dpi=600)
ggsave(paste0(out_dir,'boxplot_srgfP_shoot_rel.png'), gg2, width=10, height=10, dpi=600)
