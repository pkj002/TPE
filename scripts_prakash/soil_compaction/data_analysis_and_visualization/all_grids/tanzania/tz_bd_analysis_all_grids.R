...
# 
# saveRDS(all_pts_o, paste0('//catalogue/BaseLineDataCluster01/temp/compac_all_grids/plts_comb/all_grids/data_orig_',cnt,'.RDS'))
# saveRDS(all_pts_c, paste0('//catalogue/BaseLineDataCluster01/temp/compac_all_grids/plts_comb/all_grids/data_compact_',cnt,'.RDS'))
# 
