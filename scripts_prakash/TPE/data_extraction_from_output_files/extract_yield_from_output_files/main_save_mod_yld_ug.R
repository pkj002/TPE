...
source('//catalogue/BaseLineDataCluster01/temp/dssat_outputs/ugand/others/fun_save_mod_yld_ug.R')

plan(multisession, workers = 40)
future.apply::future_lapply(1:40, save_mod_yld_ug, comb, path, future.seed = TRUE)