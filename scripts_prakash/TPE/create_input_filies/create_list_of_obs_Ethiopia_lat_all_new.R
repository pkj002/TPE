...
dd<-readRDS('//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/cc_bc/Ethiopia/obs/pr_tmx_tmin_rad_ethi_1991_2010.RDS')
...
ln<-obs_ln[3:363]; lt<-obs_lt[3:278]
...
ln1<-which(as.character(ln)==33.025);    ln2<-which(as.character(ln)==44.025)
lt1<-which(as.character(lt)==3.025);     lt2<-which(as.character(lt)==15.025)      
...
## planting date
## 1st season
jday_init_avg<-readRDS('//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/cc_raw/scripts/sow_date_ethi_NARS_seas1_lt_14_15.RDS')
jday_init_avg<-jday_init_avg[ ,1:dimn[2]]
dim_pl<-dim(jday_init_avg)
jday_init_avg<-array(jday_init_avg,c(dim_pl[1]*dim_pl[2]))

## second season
jday_end_avg<-readRDS('//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/cc_raw/scripts/sow_date_ethi_NARS_seas2_lt_14_15.RDS')
jday_end_avg<-jday_end_avg[ ,1:dimn[2]]
...
saveRDS(yyy,'//dapadfs/workspace_cluster_12/AVISA/data_for_dssat_eaf/dssat_input/Ethiopia/obs/agMeChrips_ethi_obs_1991_2010.RDS')
#q(save='no')
