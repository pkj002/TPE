...
#for (i in 1:len){
    ...
    if(!dir.exists(paste0(out_dir,i))) {
      ...
      ## read output files
      x[[i]]<-readRDS(paste0(out_dir,i,'/PlantGro_ethiopia_obs_cult_1to5.RDS'))[,c(1:4,6:8,21:22)] 
      bb1<-x[[i]]
  ...
  saveRDS(c1,paste0(path,'PlantGro/PlantGro_1_27578_c1_',cntry,'.RDS'))
  saveRDS(c2,paste0(path,'PlantGro/PlantGro_1_27578_c2_',cntry,'.RDS'))
  saveRDS(c3,paste0(path,'PlantGro/PlantGro_1_27578_c3_',cntry,'.RDS'))
  saveRDS(c4,paste0(path,'PlantGro/PlantGro_1_27578_c4_',cntry,'.RDS'))
  saveRDS(c5,paste0(path,'PlantGro/PlantGro_1_27578_c5_',cntry,'.RDS'))
