...
out_dir<-paste0(path,'obs_cul_tz/')
setwd(out_dir)
...
#for (i in 1:len){
  for (i in 36596:len){
    ...
    ## read output files
    x[[i]]<-readRDS(paste0(out_dir,i,'/PlantGro_tz_obs_cul_1to5.RDS'))[,c(1:4,6:8,21:22)]
...
saveRDS(c1,paste0(path,'PlantGro/PlantGro_c1_36596_end_',cntry,'.RDS'))
saveRDS(c2,paste0(path,'PlantGro/PlantGro_c2_36596_end_',cntry,'.RDS'))
saveRDS(c3,paste0(path,'PlantGro/PlantGro_c3_36596_end_',cntry,'.RDS'))
saveRDS(c4,paste0(path,'PlantGro/PlantGro_c4_36596_end_',cntry,'.RDS'))
saveRDS(c5,paste0(path,'PlantGro/PlantGro_c5_36596_end_',cntry,'.RDS'))
